...
Route::get('/admin/product/configuration', 'Admin\ProductController@configuration');
Route::post('/admin/product/configuration', 'Admin\ProductController@configuration');
